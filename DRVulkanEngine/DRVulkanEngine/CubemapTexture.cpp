...
void CubemapTexture::createFromSixImages(const std::array<std::string, 6>& cubeFaces) {
    ...
    copyBufferToCubemap(stagingBuffer, cubemapSize_, cubemapSize_, false); // LDR �̹���
    // VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL -> VK_IMAGE_LAYOUT_READ_ONLY_OPTIMAL_KHR
...
void CubemapTexture::convertEquirectangularToCubemap(float* hdrData, int hdrWidth, int hdrHeight, uint32_t cubemapSize) {
    ...
    // �̹��� ���̾ƿ� ��ȯ �� ������ ����
    transitionImageLayout(VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL);
    copyBufferToCubemap(stagingBuffer, cubemapSize, cubemapSize, true); // HDR �̹���
    // VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL -> VK_IMAGE_LAYOUT_READ_ONLY_OPTIMAL_KHR
    transitionImageLayout(VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, VK_IMAGE_LAYOUT_READ_ONLY_OPTIMAL_KHR);
...
void CubemapTexture::createCubemapImage(uint32_t width, uint32_t height, VkFormat format, 
    ...
    imageInfo.flags = VK_IMAGE_CREATE_CUBE_COMPATIBLE_BIT; // ť��� �÷��� �߿�!
    imageInfo.imageType = VK_IMAGE_TYPE_2D;
    imageInfo.extent.width = width;
    imageInfo.extent.height = height;
    imageInfo.extent.depth = 1;
    imageInfo.mipLevels = 1;
    imageInfo.arrayLayers = 6; // ť����� 6�� ���̾�
...
void CubemapTexture::createCubemapImageView(VkFormat format) {
    ...
    viewInfo.viewType = VK_IMAGE_VIEW_TYPE_CUBE; // ť��� �� Ÿ��
    ...
    viewInfo.subresourceRange.layerCount = 6; // 6�� ���̾� ���
...
void CubemapTexture::createCubemapSampler() {
    ...
    samplerInfo.addressModeU = VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE; // ť����� clamp ����
...
void CubemapTexture::transitionImageLayout(VkImageLayout oldLayout, VkImageLayout newLayout) {
    ...
    barrier.subresourceRange.layerCount = 6; // 6�� ���̾� ���
